...
export default function Hero(){
  return (
    <motion.section
      ...
      className="relative overflow-hidden bg-gradient-to-r from-blue-50 via-white to-slate-50 py-16"
    >
      {/* decorative circle: partially off-screen top-right, above hero background but below content */}
      <div
        className="absolute -top-24 -right-24 w-80 h-80 rounded-full overflow-hidden pointer-events-none sm:-top-32 sm:-right-32 sm:w-96 sm:h-96 animate-none"
        style={{ zIndex: 10, animation: 'none' }}
        aria-hidden="true"
      >
        <img
      ...
      {/* keep hero content above the decorative image */}
